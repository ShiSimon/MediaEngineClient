...
public class HudFragment extends Fragment {
    ...
    private Map<String, String> getReportMap(StatesReporter report) {
        Map<String, String> reportMap = new HashMap<String, String>();
        for (StatesReporter.Value value : report.values) {
            reportMap.put(value.name, value.value);
        }
        return reportMap;
    }

    public void updateEncoderStatistics(final StatesReporter[] reports) {
