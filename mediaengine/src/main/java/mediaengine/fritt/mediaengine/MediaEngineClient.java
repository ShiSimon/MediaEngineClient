...
public class MediaEngineClient {
    ...
    public void createMediaConnection(final MEglBase mEglBase,final MediaEngineRenderer mediaEngineRenderer,final ClientInterface.SignalingParameters signalingParameters){
